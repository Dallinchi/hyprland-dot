...
Singleton {
  ...
  Item {
    ...
    property string defaultText: "#ffffff"
    property string backgroundActive: "#00000000"
    property string backgroundDefault: "#AA000000"
    property string backgroundEmpty: "#00000000"
    
    property string background: backgroundDefault

    property real bottomRightRadius: 5
    property real bottomLeftRadius: 5
    property real topRightRadius: 0
    property real topLeftRadius: 0
    property real radius: 5

    property real preferredHeight: 20

    property bool onTop: true
    // property string barBgColor: "#00000000"
    // property string buttonBorderColor: "#70e6e0"
    // property bool buttonBorderShadow: true
    // property string buttonBackgroundColor: "#70e6e0"
    // property string iconColor: "green"
    // property string iconPressedColor: "green"
  }
