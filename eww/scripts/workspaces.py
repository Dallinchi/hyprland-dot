...
def update_workspace(active_workspace):
    icons_index = [0,1,2,3,4,5,6] 
    
    icons_index[active_workspace - 1] = icons_index[active_workspace - 1] + 7
    prompt = f"(box (label :text \"{icons[icons_index[0]]}  {icons[icons_index[1]]}  {icons[icons_index[2]]}  {icons[icons_index[3]]}  {icons[icons_index[4]]}  {icons[icons_index[5]]}  {icons[icons_index[6]]}\" ))"
